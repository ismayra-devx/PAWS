...
const SAMPLE_VERIFIED_DATA = {
  ...
  measurements: [
    ...
    { name: "Eosinophils", value: "1.4 × 10³/µL", reference_range: "0.1 – 1.2 × 10³/µL", status: "Mild Elevation" },
    { name: "Serum Creatinine", value: "1.5 mg/dL", reference_range: "0.5 – 1.4 mg/dL", status: "Borderline" },
